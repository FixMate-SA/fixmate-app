        ...
        <section className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="bg-white rounded-lg shadow p-6 text-center">
              ...
              <p className="text-sm font-medium text-gray-800 mb-4">📱 +27 75 446 6571</p>
              <a href="https://wa.me/27754466571" className="bg-green-500 text-white px-4 py-2 rounded hover:bg-green-600 transition inline-block flex items-center gap-2">
