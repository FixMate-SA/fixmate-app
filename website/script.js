...
const translations = {
    en: {
        ...
        'how-it-works-subtitle': 'Simple, fast, and reliable - get your repairs done in 3 easy steps',
        'for-clients': 'For Clients',
        'step1-client': 'Describe Your Job',
        'step1-client-desc': 'Tell us what needs fixing using voice recording, photos, or text. Our AI helps create detailed job descriptions.',
        'step2-client': 'Get Matched',
        'step2-client-desc': 'Our AI instantly finds nearby verified fixers. First-come-first-serve notifications ensure quick responses.',
        'step3-client': 'Track & Pay',
        'step3-client-desc': 'Track your fixer\'s arrival in real-time. Pay securely after job completion with our transparent R20 platform fee.',
        'step1-fixer': 'Complete Verification',
        'step1-fixer-desc': 'Upload ID, proof of skills, and complete background checks. Join our verified network of trusted professionals.',
        'step2-fixer': 'Receive Job Notifications',
        'step2-fixer-desc': 'Get notified of nearby jobs matching your skills. First-come-first-serve system ensures fair opportunities.',
        'step3-fixer': 'Build Your Reputation',
        'step3-fixer-desc': 'Complete jobs, earn ratings, and climb our gamification tiers. Higher tiers = more job opportunities and better earnings.',
