...
- **Local Emergent**: `REACT_APP_BACKEND_URL=https://service-pros-2.preview.emergentagent.com`
...
cd /app/frontend
sed -i 's|https://service-pros-2.preview.emergentagent.com|https://fixmate-sa-app-a448c751e1d2.herokuapp.com|g' .env
```
