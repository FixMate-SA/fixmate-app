...
user_problem_statement: "Implement comprehensive job assignment workflow system with client terms acceptance, real-time fixer screening, first-come-first-served assignment, timeout handling, AI-powered fraud prevention, fair matching algorithms, cancellation protocols, and admin override capabilities. Enhance existing workflow with new business logic including R20 platform fee deduction, 3-hour emergency reassignment, rating penalties, and comprehensive job constraints."
